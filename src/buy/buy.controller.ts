...
export class BuyController {
  ...
  @Get(':id')
  async findBuyById(@Param('id') id: number, @Query() params: string | any): Promise<BuyEntity>{
    const parsedPopulate = params.populate ? params.populate.split(',') : [];
    delete params.populate;
  ...
  @Put(':id')
  async updateBuy(@Param('id') id: number, @Body() buy: BuyEntity): Promise<UpdateResult>{
