...
export class UserController {
  ...
  @Get(':id')
  async findUserById(@Param('id') id: number, @Query() variables: any): Promise<UserEntity> {
    const { populate, filters } = this.utilities.handlePopulate(variables);
  ...
  @Put(':id')
  async updateUser(@Param('id') id: number, @Body() user: UserEntity): Promise<UpdateResult> {
